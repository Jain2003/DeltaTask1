...
function animateArrayButtons(currentPatternLength){
    setTimeout(function(){
      ...
      console.log(buttonPattern[i]);
      document.getElementById(buttonPattern[i]).classList.add("pressed");
      setTimeout(function(){
        document.getElementById(buttonPattern[i]).classList.remove("pressed");
      },200);
